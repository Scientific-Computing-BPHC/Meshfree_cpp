...
__device__ void state_update_wall(Point* globaldata, int idx, double max_res, double* res_sqr, double U[4], double Uold[4], int rk, int euler, \
                                double* prim, double* prim_old, double* flux_res);
__device__ void state_update_outer(Point* globaldata, int idx, double Mach, double gamma, double pr_inf, double rho_inf, double theta, double max_res,\
 double* res_sqr, double U[4], double Uold[4], int rk, int euler, double* prim, double* prim_old, double* flux_res);
